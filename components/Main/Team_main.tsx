...
const TeamEDC = () => {
    return (
        <div className="container px-6 mx-auto">
            ...
            <section className="mb-32 text-dimWhite text-center">

                <h2 className="font-poppins font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full sm:py-16 py-6">Meet our <u className="text-gradient">Mentors</u></h2>


                <div className="grid place-content-center md:grid-cols-3 gap-x-6 lg:gap-x-12">
                    <div className="mb-6 lg:mb-0">
                        <div className="bg-white block rounded-lg shadow-lg">
                            <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                <Image width={500} height={500} alt='' src={arpit} className="w-full rounded-t-lg" />
                                <a href="#!">
                    ...
                    <div className="mb-6 lg:mb-0">
                        <div className="bg-white block rounded-lg shadow-lg">
                            <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                <Image width={500} height={500} alt='' src={arushi} className="w-full rounded-t-lg" />
                                <a href="#!">
                                    <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"></div>
                                </a>
                                <svg className="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                ...
                <h2 className="font-poppins font-semibold xs:text-[48px] text-[40px] text-white xs:leading-[76.8px] leading-[66.8px] w-full sm:py-16 py-6">Meet the <u className="text-gradient">team</u></h2>
                ...
                <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
                    ...
                    <div className="">
                        <div className="bg-white block rounded-lg shadow-lg">
                            <div className="relative overflow-hidden bg-no-repeat bg-cover">
                                <Image width={500} height={500} alt='' src={divyansh} className="w-full rounded-t-lg" />
                                <a href="#!">
                                    <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"></div>
                                </a>
                                <svg className="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
